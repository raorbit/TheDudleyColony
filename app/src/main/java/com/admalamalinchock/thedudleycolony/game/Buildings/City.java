...
public class City extends Building
{
    ...
    public City()
    {
        super(new BigDecimal(4000),new BigDecimal("1.1"),new BigDecimal("5"),"City",2,3);      //using the super class so that we can give the standard price and name of the building
