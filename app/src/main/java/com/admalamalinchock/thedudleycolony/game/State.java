 ...
 */
public class State extends Buildings
{
    ...
    {
        super(new BigDecimal(5),"State");      //using the super class so that we can give the standard price and name of the building
        this.rate=rate;
    }
