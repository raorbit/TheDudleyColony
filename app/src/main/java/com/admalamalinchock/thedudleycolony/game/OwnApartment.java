 ...
 */
public class OwnApartment extends Buildings
{
    private double rate;        //like the getPrice method but we can change this for different buildings later in the main class
    public OwnApartment(double rate)
    {
        super(new BigDecimal(5),"OwnApartment");      //using the super class so that we can give the standard price and name of the building
        this.rate=rate;
    }
